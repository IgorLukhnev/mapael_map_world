...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        initDelegatedMapEvents: function() {
            ...
            self.$container.on("mousemove." + pluginName, "[data-id]", function (event) {
                ...
                mapMouseMoveTimeoutID = setTimeout(function() {
                    ...
                    if (dataTypeToElementMapping[type] !== undefined  || dataTypeToElementMapping[type] !== self.areas) {
        ...
        elemEnter: function (elem) {
            ...
            if ((elem.mapElem !== undefined || elem.textElem !== undefined) && self.paper !== undefined) {
        ...
        elemHover: function (elem, event) {
            var self = this;
            if (elem === undefined) return;
            if (elem.options.cssClass === "area") return;
